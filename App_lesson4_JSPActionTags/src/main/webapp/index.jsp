...
<jsp:useBean id="mobiles" class="ConsumerGoods.Mobiles" scope="session"></jsp:useBean>
        <jsp:setProperty property="productId" name="mobiles" value="1234"/>
        <jsp:setProperty property="productName" name="mobiles" value="iphone 13"/>
        <jsp:setProperty property="price" name="mobiles" value="83000.00"/>
